...
ElectroMarket Analytics — порфтольный проект по анализу данных интернет-магазина электроники.
...
В рамках проекта был проведен анализ, позволяющий ответить на следующие вопросы:
